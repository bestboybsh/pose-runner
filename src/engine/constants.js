...
export const GAME_CONFIG = {
  ...
  MAX_SPEED: 80,  // 최대 속도 (초기 속도의 10배) (8 * 10 = 80)
  SPEED_INCREMENT: 2.0,  // 속도 증가량 (5초마다 증가)
  SPEED_INTERVAL: 300,  // 속도 증가 간격 (5초마다, 60fps 기준 300프레임)
  GRAVITY: 0.9,
  ...
  OBSTACLE: {
    ...
    HIGH_OFFSET: 50,  // 높은 장애물 오프셋 (점프로 넘을 수 있도록 충분히 낮게) (70 -> 50)
    DUCK_W: 75,  // 숙여야 하는 장애물 너비 증가 (50 -> 75)
    DUCK_H: 150,  // 숙여야 하는 장애물 높이 (숙였을 때 플레이어와 겹치도록, 점프 최대 높이보다 높아서 점프로 못 넘음) (200 -> 150, 상단: 340-150=190, 플레이어 숙였을 때 상단 295와 겹침)
